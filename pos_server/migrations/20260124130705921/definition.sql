...
--
-- Class ArticleComposition as table article_compositions
--
...
CREATE TABLE "building" (
    ...
    "authUserId" uuid,
    "tableMultiOrder" boolean NOT NULL,
    "orderWithCashRegister" boolean NOT NULL,
    "cashRegisterLimitPerDay" bigint,
    "allowAppendingItemsToOrder" boolean NOT NULL,
    "autoCloseOrdersAtClosingTime" boolean NOT NULL,
...
--
-- Class CashRegister as table cash_register
--
CREATE TABLE "cash_register" (
    "id" uuid PRIMARY KEY DEFAULT gen_random_uuid(),
    "start" timestamp without time zone NOT NULL,
    "startAmount" double precision DEFAULT 0.0,
    "end" timestamp without time zone,
    "endAmount" double precision DEFAULT 0.0,
...
--
-- Class Ingredient as table ingredients
--
...
CREATE TABLE "order_items" (
    ...
    "payMethode" text NOT NULL DEFAULT 'cash'::text
);
...
--
-- Foreign relations for "access" table
--
...
--
-- Foreign relations for "article_compositions" table
--
...
--
-- Foreign relations for "b_tables" table
--
...
--
-- Foreign relations for "building" table
--
...
--
-- Foreign relations for "cash_register" table
--
...
--
-- Foreign relations for "employers" table
--
...
--
-- Foreign relations for "ingredients" table
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('pos', '20260124130705921', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260124130705921', "timestamp" = now();
