...
CREATE TABLE "building" (
    ...
    "orderWithCashRegister" boolean NOT NULL DEFAULT false,
    "cashRegisterLimitPerDay" bigint NOT NULL DEFAULT 3,
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('pos', '20260123131938113', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260123131938113', "timestamp" = now();
